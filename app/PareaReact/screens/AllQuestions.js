      ...
      <Block flex style={styles.container}>
        ...
        <Block>
          <Text style={{fontSize: 17, padding: '3%'}}>
            Viewing all <Text style={{fontWeight: '600'}}>{questionsArray !== null ? questionsArray.length : "" } </Text>questions
          </Text>
        </Block>
        <ScrollView>
          <Block flex>
            {
              ...
              <Block>
                <Text>
                "No questions yet! Add a question to help the community learn."
                </Text>
              </Block>
              :
              <Block>
